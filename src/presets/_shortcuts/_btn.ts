...
export const staticBtn: Record<`${BtnPrefix}-${string}` | BtnPrefix, string> = {
  ...
  // variants
  "btn-solid-white":
    "bg-base text-base ring-1 ring-base ring-inset shadow-sm btn-focus hover:bg-muted",
  "btn-ghost-white": "text-base btn-focus hover:bg-$c-gray-50",
  "btn-outline-white":
    "text-base ring-1 ring-base ring-inset btn-focus hover:bg-$c-gray-50",

  "btn-solid-gray":
    "bg-$c-gray-50 text-$c-gray-800 ring-1 ring-base ring-inset shadow-sm btn-focus hover:bg-$c-gray-100",
  "btn-ghost-gray": "text-$c-gray-600 btn-focus hover:bg-$c-gray-100",
  "btn-soft-gray":
    "text-$c-gray-600 bg-$c-gray-50 btn-focus hover:bg-$c-gray-100",
  "btn-outline-gray":
    "text-muted hover:text-$c-gray-600 ring-1 ring-base ring-inset btn-focus hover:bg-$c-gray-50",
  "btn-link-gray":
    "text-muted btn-focus hover:text-base hover:underline underline-offset-4",
...
export const dynamicBtn: [RegExp, (params: RegExpExecArray) => string][] = [
  ...
  [
    /^btn-solid(-(\S+))?$/,
    ([, , c = "primary"]) =>
      `btn-focus-${c} text-inverted shadow-sm bg-${c}-600 hover:bg-${c}-500 dark:bg-${c}-500 dark:hover:bg-${c}-400`,
  ],
  [
    /^btn-text(-(\S+))?$/,
    ([, , c = "primary"]) =>
      `btn-focus-${c} text-${c}-600 dark:text-${c}-500 hover:text-${c}-500 dark:hover:text-${c}-400`,
  ],
  [
    /^btn-outline(-(\S+))?$/,
    ([, , c = "primary"]) =>
      `btn-focus-${c} text-${c}-500 dark:text-${c}-400 ring-1 ring-inset ring-${c}-500 dark:ring-${c}-400 hover:bg-${c}-50 dark:hover:bg-${c}-950`,
  ],
  [
    /^btn-soft(-(\S+))?$/,
    ([, , c = "primary"]) =>
      `btn-focus-${c} text-${c}-600 dark:text-${c}-400 bg-${c}-50 dark:bg-${c}-950 hover:bg-${c}-100 dark:hover:bg-${c}-900`,
  ],
  [
    /^btn-ghost(-(\S+))?$/,
    ([, , c = "primary"]) =>
      `btn-focus-${c} text-${c}-600 dark:text-${c}-400 hover:bg-${c}-100 dark:hover:bg-${c}-900`,
  ],
  [
    /^btn-link(-(\S+))?$/,
    ([, , c = "primary"]) =>
